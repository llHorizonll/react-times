  ...
  _createClass(ClassicTheme, [{
    ...
    value: function render() {
      var _props4 = this.props,
          ...
          _props4$disabledTimes = _props4.disabledTimes,
          disabledTimes = _props4$disabledTimes === undefined ? {} : _props4$disabledTimes;


      var disRangeTimes = timeMode === 12 ? _time2.default.get12ModeTimes(disabledTimes) : _time2.default.get24ModeTimes(disabledTimes);

      var timeDatas = timeMode === 12 ? _time2.default.get12ModeTimes(timeConfig).filter(function (t) {
        return !disRangeTimes.includes(t);
      }) : _time2.default.get24ModeTimes(timeConfig).filter(function (t) {
        return !disRangeTimes.includes(t);
      });
      return _react2.default.createElement(
        "div",
